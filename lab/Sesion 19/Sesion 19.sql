...
/*
1. Diseña una estrategia de respaldo para el esquema curso_topicos. Documenta la estrategia en comentarios y escribe un script 
RMAN para un respaldo completo y un respaldo incremental.
*/
...
/*
2. Simula un fallo eliminando la tabla Productos y recupera los datos usando 
Flashback (si está habilitado) o RMAN. Documenta el proceso.
*/
-- Simular fallo
