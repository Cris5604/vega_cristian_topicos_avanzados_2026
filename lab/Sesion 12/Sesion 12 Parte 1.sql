...
-- Sesion 12 EJERCICIOS DE PROCEDIMIENTOS, FUNCIONES Y TRIGGERS : Actividad Pracica 1 
-- Función
/*
Crea una función calcular_total_con_descuento que reciba un PedidoID (parámetro IN) y devuelva el total del pedido con un descuento del 10%
si el total supera 1000. Usa la función en un procedimiento aplicar_descuento_pedido que actualice el total del pedido.
*/
