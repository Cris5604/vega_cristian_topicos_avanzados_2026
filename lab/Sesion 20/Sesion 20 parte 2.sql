...
/*
Crea un trigger auditar_eliminacion_pedido que se dispare después de eliminar un pedido y registre el 
PedidoID, ClienteID, Total y la fecha de eliminación en una tabla de auditoría AuditoriaPedidos.
*/
